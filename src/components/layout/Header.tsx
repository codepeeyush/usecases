...
const navLinks = [
  { to: summitTrailPaths.shop, label: 'Shop All' },
  { to: summitTrailPaths.category('footwear'), label: 'Footwear' },
  { to: summitTrailPaths.category('backpacks'), label: 'Backpacks' },
  { to: summitTrailPaths.category('clothing'), label: 'Clothing' },
  { to: summitTrailPaths.category('accessories'), label: 'Accessories' },
]
