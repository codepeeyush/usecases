...
const shopLinks = ['Shop All', 'Footwear', 'Backpacks', 'Clothing', 'Accessories', 'Sale']
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 pb-14 border-b border-white/10">
          ...
          <div className="md:col-span-2">
            <Link to="/" className="cursor-pointer inline-flex items-center gap-2.5 mb-5 group" aria-label="Summit Trail home">
