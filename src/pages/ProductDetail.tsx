  ...
  if (!product) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-24 text-center">
        ...
        <Link to="/shop" className="cursor-pointer text-primary underline underline-offset-2 hover:opacity-70 transition-opacity duration-150">
          Back to shop
        </Link>
      </div>
    )
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <nav aria-label="Breadcrumb">
          <p className="text-[12px] text-muted-foreground">
            <Link to="/" className="cursor-pointer hover:text-foreground transition-colors duration-150">Home</Link>
            <span className="mx-1.5 opacity-40">/</span>
            <Link to="/shop" className="cursor-pointer hover:text-foreground transition-colors duration-150">Shop</Link>
            <span className="mx-1.5 opacity-40">/</span>
            <Link
